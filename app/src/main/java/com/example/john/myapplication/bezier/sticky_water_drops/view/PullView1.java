package com.example.john.myapplication.bezier.sticky_water_drops.view;
...
public class PullView1 extends View {
    ...
    public PullView1(Context context) {
        this(context, null);
    }

    public PullView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
