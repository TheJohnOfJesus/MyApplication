package com.hebccc.multimedia.video.exo;
...
import com.hebccc.multimedia.R;
import com.hebccc.multimedia.video.JZMediaInterface;
...
public class JZMediaExo extends JZMediaInterface implements Player.EventListener, VideoListener {
    ...
    public boolean isPlaying() {
        return simpleExoPlayer==null?false:simpleExoPlayer.getPlayWhenReady();
    }

    @Override
    public void seekTo(long time) {
        if (time != previousSeek&&simpleExoPlayer!=null) {
